...
const supabaseUrl = process.env.SUPABASE_URL || process.env.VITE_SUPABASE_URL; // Fallback for local
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_KEY || process.env.VITE_SUPABASE_ANON_KEY;
// Use Service Role key if possible to bypass RLS for auth ops, or Anon key if RLS allows.
// For integrations table upsert, we might need Service Role or ensure Policy allows it.
